...
Cannot compile : Successfully Compiles
Compiler warnings : 0 Warnings
"make clean" : Successfull
Segmentation faults : 0
Separate compilation : Not Required
Malformed input : None
Too slow : No
Bad commandline : No
Did not use My402List and My402ListElem to implement "sort" in (B) : Used the required Linked list.

+------+
| BUGS |
+------+
1) No functional bugs.
+------------------+
| OTHER (Optional) |
+------------------+
